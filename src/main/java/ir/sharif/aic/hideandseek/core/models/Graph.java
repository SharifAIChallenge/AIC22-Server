...
public class Graph {
    ...
    private final int visibleRadiusXPoliceThief;
    private final int visibleRadiusYPoliceJoker;
    private final int visibleRadiusZThiefBatman;

    public Graph(int visibleRadiusXPoliceThief, int visibleRadiusYPoliceJoker, int visibleRadiusZThiefBatman) {
        this.nodeMap = new HashMap<>();
        this.pathMap = new HashMap<>();
        this.adjacencyMap = new HashMap<>();
        this.visibleRadiusXPoliceThief = visibleRadiusXPoliceThief;
        this.visibleRadiusYPoliceJoker = visibleRadiusYPoliceJoker;
        this.visibleRadiusZThiefBatman = visibleRadiusZThiefBatman;
    }
    ...
    public HideAndSeek.Graph toProto() {
        return HideAndSeek.Graph.newBuilder()
                .setVisibleRadiusXPoliceThief(this.visibleRadiusXPoliceThief)
                .setVisibleRadiusYPoliceJoker(this.visibleRadiusYPoliceJoker)
                .setVisibleRadiusZThiefBatman(this.visibleRadiusZThiefBatman)
